  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity onPress={handleSettingsPress} style={styles.topBar}>
        <Image style={styles.back} source={require("@/src/assets/images/settings/back.png")} />
      </TouchableOpacity>
      ...
      <View style={styles.historySection}>
        <ScrollView style={[styles.historyList, { height: screenHeight * 0.3 }]}>
          <View style={styles.component}>
            <Image style={styles.png} source={require("@/src/assets/images/settings/account.png")} />
            <Text style={styles.componentText}>Account & Policy</Text>
          </View>
          <View style={styles.component}>
            <Image style={styles.png} source={require("@/src/assets/images/settings/bookmark.png")} />
            <Text style={styles.componentText}>Manage Data</Text>
          </View>
          <View style={styles.component}>
            <Image style={styles.png} source={require("@/src/assets/images/settings/night-mode.png")} />
            <Text style={styles.componentText}>Dark Mode & Appearences</Text>
          </View>
          <View style={styles.component}>
            <Image style={styles.png} source={require("@/src/assets/images/settings/bell.png")} />
            <Text style={styles.componentText}>Notifications</Text>
          </View>
          <View style={[styles.component, styles.lastComponent]}>
            <Image style={styles.png} source={require("@/src/assets/images/settings/bin.png")} />
